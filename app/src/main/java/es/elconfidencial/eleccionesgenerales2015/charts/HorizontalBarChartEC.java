 ...
 */
public class HorizontalBarChartEC extends BarChart {

    public HorizontalBarChartEC(Context context) {
        super(context);
    }

    public HorizontalBarChartEC(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public HorizontalBarChartEC(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new HorizontalBarChartRendererEC(this, mAnimator, mViewPortHandler);
