 ...
 */
public class BarChartEC extends BarLineChartBase<BarData> implements BarDataProvider {
    ...
    public BarChartEC(Context context) {
        super(context);
    }

    public BarChartEC(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BarChartEC(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init() {
        ...
        mRenderer = new BarChartRendererEC(this, mAnimator, mViewPortHandler);
        mXAxisRenderer = new XAxisRendererBarChartEC(mViewPortHandler, mXAxis, mLeftAxisTransformer, this);
