package com.elconfidencial.eceleccionesgenerales2015.views;
...
public class DonutProgress extends View {
    ...
    private final int default_startingDegree = 180;
    ...
    protected void initPainters() {
       ...
       // textPaint.setTypeface(Typeface.createFromAsset(context.getAssets(), "Titillium-Regular.otf"));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!TextUtils.isEmpty(text)) {
            ...
            textPaint.setTypeface(Typeface.createFromAsset(getContext().getAssets(), "Titillium-Light.otf"));
